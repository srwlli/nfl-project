...
CREATE TABLE season_leaderboards (
    ...
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    deleted_at TIMESTAMP DEFAULT NULL,
    CONSTRAINT fk_season_leaderboards_player FOREIGN KEY (player_id) REFERENCES players(player_id),
    CONSTRAINT fk_season_leaderboards_season FOREIGN KEY (season) REFERENCES seasons(season)
);

CREATE INDEX idx_season_leaderboards_season_cat ON season_leaderboards(season, stat_category, rank) WHERE deleted_at IS NULL;

COMMENT ON TABLE season_leaderboards IS 'Season stat leaders (55,000+ records)';

-- TABLE: career_leaderboards
CREATE TABLE career_leaderboards (
    career_leaderboard_id SERIAL PRIMARY KEY,
    stat_category VARCHAR(50) NOT NULL,
    player_id VARCHAR(50) NOT NULL,
    stat_value DECIMAL(10,2) NOT NULL,
    rank INTEGER NOT NULL,
    ...
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    deleted_at TIMESTAMP DEFAULT NULL,
    CONSTRAINT fk_career_leaderboards_player FOREIGN KEY (player_id) REFERENCES players(player_id)
);

CREATE INDEX idx_career_leaderboards_cat ON career_leaderboards(stat_category, rank) WHERE deleted_at IS NULL;

COMMENT ON TABLE career_leaderboards IS 'All-time career leaders (10,000+ records)';

-- TABLE: active_leaderboards
CREATE TABLE active_leaderboards (
    active_leaderboard_id SERIAL PRIMARY KEY,
    stat_category VARCHAR(50) NOT NULL,
    player_id VARCHAR(50) NOT NULL,
    stat_value DECIMAL(10,2) NOT NULL,
    rank INTEGER NOT NULL,
    ...
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    deleted_at TIMESTAMP DEFAULT NULL,
    CONSTRAINT fk_active_leaderboards_player FOREIGN KEY (player_id) REFERENCES players(player_id)
);

CREATE INDEX idx_active_leaderboards_cat ON active_leaderboards(stat_category, rank) WHERE deleted_at IS NULL;

COMMENT ON TABLE active_leaderboards IS 'Active player rankings (2,000+ records)';

-- TABLE: rookie_leaderboards
CREATE TABLE rookie_leaderboards (
    rookie_leaderboard_id SERIAL PRIMARY KEY,
    season INTEGER NOT NULL,
    stat_category VARCHAR(50) NOT NULL,
    player_id VARCHAR(50) NOT NULL,
    stat_value DECIMAL(10,2) NOT NULL,
    ...
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    deleted_at TIMESTAMP DEFAULT NULL,
    CONSTRAINT fk_rookie_leaderboards_player FOREIGN KEY (player_id) REFERENCES players(player_id),
    CONSTRAINT fk_rookie_leaderboards_season FOREIGN KEY (season) REFERENCES seasons(season)
);

CREATE INDEX idx_rookie_leaderboards_season ON rookie_leaderboards(season, stat_category, rank) WHERE deleted_at IS NULL;

COMMENT ON TABLE rookie_leaderboards IS 'Rookie season rankings (500+ records)';
